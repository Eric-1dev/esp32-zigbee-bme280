...
#define SECONDS_TO_SLEEP 30               // Время сна
...
extern "C"
{
    ...
    void app_main(void)
    {
        ...
        register_reboot_success_callback([]() {
            xTaskCreate(send_data_once_task, "deep_sleep", 2048, NULL, 5, NULL);
        });
        ...
        register_network_joined_callback([]() {
            led_turn_on(250);
            xTaskCreate(send_data_periodically_task, "deep_sleep", 2048, NULL, 5, NULL);
        });
